...
class Editprofile extends StatefulWidget {
  ...
  const Editprofile({Key key, this.displayName, this.username, this.firstName, this.lastName, this.gender, this.customGender, this.mytoken, this.id, this.email, this.image}) : super(key: key);
  @override
...
Future getImage() async {
  print("getImage");
    ...
    if (image != null) {
      ...
      print(img64);
      var responseProfileImage = await Api.updataimage(widget.id ,img64,"basic-ios.png",widget.mytoken);

      if (responseProfileImage != null && responseProfileImage.statusCode == 200){
    ...
    .addPostFrameCallback((_) => _scaffoldKey.currentState.showSnackBar(SnackBar(
    ...
    fit: BoxFit.cover
                    ...
                    child:Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                           image: new NetworkImage("https://today-api.moveforwardparty.org/api${widget.image}/image"),
             ...
             _isloading == true
              ...
              child: InkWell(
                onTap: () async {
                        ...
                        await editprofile(
                            displayName,widget.email, firstName, lastName,selecr, genderother == true
                                      ? ""
                                      :  "",widget.mytoken,widget.id);
                      },
                child:Center(
                child: Text(
                  "แก้ไข",
