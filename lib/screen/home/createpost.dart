...
// class CreatePostSc extends StatefulWidget {
//     final String myuid;
//   final String token;

//   const CreatePostSc({Key key, this.myuid, this.token}) : super(key: key);
//   // const CreatePostSc({ Key? key }) : super(key: key);

//   @override
//   _CreatePostScState createState() => _CreatePostScState();
// }

// class _CreatePostScState extends State<CreatePostSc> {
...
//                     await Api.createpost(widget.myuid,
//                             widget.token,_titleController.text, _detailController.text)
//                         .then((response) => ({
